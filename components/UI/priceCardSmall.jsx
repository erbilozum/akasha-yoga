                    ...
                    {!visible ? null :
                        <div className={"visible mt-1"}>
                            <form action="https://getform.io/f/9e91b82f-b465-4863-88c1-253fd4c6ad1f" method="POST">
                                <input name={"fullName"} className={`bg-white border-2 border-[${props.data.colorCode}] focus:outline-none focus:border-[${props.data.colorCode}] text-sm w-full text-gray-700 mt-2 px-2 py-2`} type={"text"} id={"txtFullName"} placeholder={"Ad Soyad"} />
                                <input name={"phone"} className={`bg-white border-2 border-[${props.data.colorCode}]  focus:outline-none text-sm w-full text-gray-700 mt-2 px-2 py-2`} type={"tel"} id={"txtPhone"} placeholder={"Telefon"} />
