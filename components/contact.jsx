...
const Contact = () => {
    return (
        <div name={"contact"} className={"container mx-auto px-4 bg-white select-none"}>
            {/*Header*/}
            ...
            <div className='font-NatoSans'>
                ...
                <form className="w-full flex flex-col items-center justify-center space-y-2">
                    <input type='text' className='w-2/6 p-1 bg-white border-fuchsia-800 border-2 select-text' placeholder="Full Name" required />
                    <input type='email' className='w-2/6 p-1 bg-white border-fuchsia-800 border-2 select-text' placeholder="info@somebody.com" required />
                    <input type='tel' className='w-2/6 p-1 bg-white  border-fuchsia-800 border-2 select-text' placeholder="0 (123) 456 78 90" required />
