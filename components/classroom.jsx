...
const Classroom = () => {
    return (
        <div name={"classroom"} className={"container mx-auto px-4"}>
            ...
            <div className={"flex flex-row justify-between mb-10 space-x-6"}>
                <div className='border hover:bg-gray-100 hover:scale-105 duration-500 ease-in-out transition-all bg-white border-gray-200 rounded-xl shadow-xl w-1/4 px-6 '>
                    ...
                    <p className="text-gray-700 tracking-widest justify-between inset-4">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati quod dolorem nam beatae sit voluptatem sequi natus ea odit. Id nulla necessitatibus recusandae quos dolores deleniti error minima corrupti! Earum?                    </p>
                </div>
                <div className='border hover:bg-gray-100 hover:scale-105 duration-500 ease-in-out transition-all bg-white border-gray-200 rounded-xl shadow-xl w-1/4 px-6 '>
                ...
                <div className='border hover:bg-gray-100 hover:scale-105 duration-500 ease-in-out transition-all bg-white border-gray-200 rounded-xl shadow-xl w-1/4 px-6 '>
                    ...
                    <p className="text-gray-700 tracking-widest justify-between inset-4">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptate corrupti qui assumenda. Similique, aut rem quibusdam hic natus earum. Cumque, eius obcaecati! Necessitatibus laborum voluptatem aliquid, quaerat reprehenderit eos beatae!</p>
                </div>
                <div className='border hover:bg-gray-100 hover:scale-105 duration-500 ease-in-out transition-all bg-white border-gray-200 rounded-xl shadow-xl w-1/4 px-6 '>
                    <div className='flex items-center justify-center'>
                        <Image
